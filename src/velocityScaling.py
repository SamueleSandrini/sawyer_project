...
def main():
    ...
    actual_speed_ratio = nominal_speed_ratio # da leggere da qualche parte
        ...
        for human_keypoint in human_keypoints:
            for tf_name_robot_link in robot_tf_link_to_check:
                try:
                    ...
                    rospy.loginfo("Relative distance: {}".format(relative_distance))
